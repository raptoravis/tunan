...
| [`/ce-report-bug`](../../docs/skills/ce-report-bug.md)                   | Report a bug in the tunan plugin                                                                                                                                                                               |
...
| [`/ce-update`](../../docs/skills/ce-update.md)                           | Check tunan plugin version and fix stale cache (Claude Code only)                                                                                                                                              |
| [`/ce-release-notes`](../../docs/skills/ce-release-notes.md)             | Summarize recent tunan plugin releases, or answer a question about a past release with a version citation                                                                                                      |
