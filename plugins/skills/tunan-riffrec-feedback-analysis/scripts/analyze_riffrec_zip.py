...
def write_requirements_kickoff(
    ...
    lines.extend(
        [
            ...
            "- `tunan-brainstorm` can confirm requirements from linked source evidence before any planning begins.",
            "",
            "---",
            "",
            "## Scope Boundaries",
            ...
            "- Brainstorm before plan: Use `tunan-brainstorm` to refine product behavior when the recording reveals ambiguity.",
            "",
            "---",
            "",
...
def main() -> int:
    ...
    print(f"Brainstorm handoff: $tunan:tunan-brainstorm {display_path(kickoff_md, repo_root)}")
