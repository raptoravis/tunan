---
name: tunan-riffrec-feedback-analysis
...
- **Extensive analysis** — input is a longer recording, contains multiple issues / requirements / workflow walkthroughs, or the user wants requirements or brainstorm material. Read `references/extensive-analysis.md`. Always continue into the `tunan-brainstorm` skill.
...
The Compound Engineering output format used by the extensive path is documented in `references/tunan-feedback-format.md`.
