...
- **Suggested next step** — single sentence: file an issue, open `tunan-debug`, or escalate to extensive analysis if more issues surfaced.
...
- No automatic handoff to `tunan-brainstorm`. The quick path ends with the bug report.
