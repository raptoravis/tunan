...
The cached project profile's stack/versions (or, when uncached, the `tunan:repo-research-analyst` Technology & Infrastructure summary) gives you the technology context. Use it to make sharper external research decisions:
