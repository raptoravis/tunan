...
> `python3` is required to run `/tunan-release-notes`. Install Python 3.x and retry, or open https://github.com/EveryInc/tunan-plugin/releases directly.
