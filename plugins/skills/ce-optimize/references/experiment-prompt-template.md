...
- For Codex dispatch: write the filled template to a temp file and pipe via stdin (`cat ${TMPDIR:-/tmp}/optimize-exp-XXXXX.txt | codex exec --skip-git-repo-check - 2>&1`).
