...
- `yunxing:req` issues -- requirements created by brainstorm / newreq
- `yunxing:plan` issues -- plans created by plan (decision artifacts; execution progress is derived from git, not stored in plan bodies)
