...
- **The planning agent** (`yunxing-plan` or a human) produces an implementation
...
- **Success Criteria** — include when there are quality / metric / handoff
  ...
  one voice"), process / handoff quality ("yunxing-doc-review can act on this
...
- **No process exhaust.** No "captured at Phase X" notes, no `## Next Steps`
  pointing to yunxing-plan, no italic provenance lines. Engineering process
