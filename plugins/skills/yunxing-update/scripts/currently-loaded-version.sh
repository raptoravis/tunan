...
# marketplace cache layout `~/.claude/plugins/cache/<marketplace>/yunxing/<version>/skills/yunxing-update`,
...
# Match `.../plugins/cache/*/yunxing/<version>/skills/yunxing-update[/]?`
# Capture group 1 is the version segment.
version=$(printf '%s\n' "$skill_dir" | sed -nE 's|.*/plugins/cache/[^/]+/yunxing/([^/]+)/skills/yunxing-update/?$|\1|p')
