...
Return these values to the caller (e.g., tunan-commit-push-pr):
...
- The caller applies the label when formatting. tunan-demo-reel does not generate markdown.
