...
> Diff-scoped browser QA of `<branch>` vs `main`. Generated by `/yunxing-dogfood-beta` on <YYYY-MM-DD>.
...
<Reusable lessons worth carrying forward — patterns, gotchas, product/UX insights. Feed substantial ones to `yunxing-compound`.>
