...
def write_requirements_kickoff(
    ...
    lines.extend(
        [
            ...
            "- `yunxing-brainstorm` can confirm requirements from linked source evidence before any planning begins.",
            "",
            "---",
            "",
            "## Scope Boundaries",
            ...
            "- Brainstorm before plan: Use `yunxing-brainstorm` to refine product behavior when the recording reveals ambiguity.",
            "",
            "---",
            "",
...
def main() -> int:
    ...
    print(f"Brainstorm handoff: $yunxing:yunxing-brainstorm {display_path(kickoff_md, repo_root)}")
