...
Return these values to the caller (e.g., yunxing-commit-push-pr):
...
- The caller applies the label when formatting. yunxing-demo-reel does not generate markdown.
