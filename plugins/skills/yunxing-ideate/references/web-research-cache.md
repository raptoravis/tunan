...
Files live under `<scratch-dir>/web-research-cache.json`, where `<scratch-dir>` is `${TMPDIR:-/tmp}/yunxing/yunxing-ideate/<run-id>`, resolved once in SKILL.md Phase 1.
...
```bash
SCRATCH_ROOT="${TMPDIR:-/tmp}/yunxing/yunxing-ideate"
