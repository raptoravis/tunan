...
> Diff-scoped browser QA of `<branch>` vs `main`. Generated by `/tunan-dogfood-beta` on <YYYY-MM-DD>.
...
<Reusable lessons worth carrying forward — patterns, gotchas, product/UX insights. Feed substantial ones to `tunan-compound`.>
