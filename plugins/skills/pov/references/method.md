...
An approach-set POV judges only the options the user or conversation supplied; generating a new option field belongs to `ideate` or `brainstorm`. Lead with a plain-language **Position**, then state:
