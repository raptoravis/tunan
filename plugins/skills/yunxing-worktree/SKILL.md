---
name: yunxing-worktree
description: Create an isolated git worktree for parallel feature work or PR review. Use when starting work that should not disturb the current checkout, or when `yunxing-work` or `yunxing-code-review` offers a worktree option.
