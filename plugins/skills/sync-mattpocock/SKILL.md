...
- `grill-me` / `grilling` → **Already synced** (tunan:grill-me absorbed grilling; 2026-07-08 sync absorbed facts-vs-decisions distinction + "don't enact until confirmed" rule; 2026-07-18 sync absorbed "decision tree" terminology + broader fact-source language "environment (filesystem, tools, etc.)")
- `loop-me` → **Already synced** (tunan:loop-me)
- `research` → **Already synced** (tunan:research — created 2026-07-08)
- `wayfinder` → **Already synced** (tunan:wayfinder — created 2026-07-08; 2026-07-18 sync absorbed "decision tickets" terminology; upstream promoted from in-progress to engineering)
- `to-spec` (was `to-prd`) → **Partial overlap** (tunan:brainstorm covers requirements synthesis; renamed upstream 2026-07; non-interactive mode already handled by brainstorm Phase 0.2 fast-path; Testing Decisions section + seam-sketching are candidates for future absorption into brainstorm references)
- `to-issues` → **Removed upstream** (was Already covered by tunan:plan; deleted from mattpocock/skills as of 2026-07-18 sync)
- `to-tickets` → **Already synced** (tunan:to-tickets — created 2026-07-18)
- `batch-grill-me` → **Already synced** (tunan:batch-grill-me — created 2026-07-18)
- `to-questionnaire` → **Already synced** (tunan:to-questionnaire — created 2026-07-18)
- `setup-ts-deep-modules` → **Out of scope** (Matt-specific TypeScript tooling setup, reviewed 2026-07-18)
- `handoff` → **Already covered** (tunan:handoff — different implementation, same purpose; 2026-07-18 diff was cosmetic: PRDs→specs terminology)
...
- `implement` / `prototype` → **Already covered** (tunan:work; 2026-07-18 diff was cosmetic: PRD→spec terminology alignment)
