---
name: tunan-best-practices-researcher
...
2. **Identify Relevant Skills**:
   ...
   - Rails/Ruby → `tunan-dhh-rails-style`
   - Frontend/Design → `tunan-frontend-design`, `swiss-design`
   - TypeScript/React → `react-best-practices`
   - AI/Agents → `tunan-agent-native-architecture`
   - Documentation → `tunan-compound`
   - File operations → `rclone`, `tunan-worktree`
   - Image generation → `tunan-gemini-imagegen`
