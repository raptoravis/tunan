---
name: tunan-git-history-analyzer
...
Note that files in `docs/plans/` and `docs/solutions/` are tunan pipeline artifacts created by `/tunan-plan`. They are intentional, permanent living documents — do not recommend their removal or characterize them as unnecessary.
