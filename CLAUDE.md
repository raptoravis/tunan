...
**Cache trap:** `~/.claude/plugins/cache/tunan/` is a stale cache copy. Always edit under `plugins/` in the repo, not the cache. If you accidentally edited the cache, diff it against the repo source and re-apply to the correct file.
